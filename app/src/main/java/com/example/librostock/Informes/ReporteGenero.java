...
public class ReporteGenero {
    ...
    public ReporteGenero(Context contexto) {
    ...
    private void cargarDatos(){
        ...
        String[] encabezadoReporteAutor = {"GÉNERO", "TÍTULOS", "CANTIDAD"};
        agregarMetadatos("Reporte Género", "Número Libros x Género", "LibroStock");
        agregarTitulos("Reporte Libros x Género", "Número Libros x Género", fecha, hora);
        //agregarParrafo(textoCorto);
        //agregarParrafo(textLargo);
        ArrayList<ReporteLibrosxGenero> listaReporteLibrosxGenero = delegar.reporteLibrosxGenero(contexto);
        System.out.println("LISTA REPORTE LIBROS x GÉNERO: "+listaReporteLibrosxGenero.toString());
        crearTabla(encabezadoReporteAutor, listaReporteLibrosxGenero);
    ...
    private void crearArchivo(){
        ...
        if(!carpeta.exists())
            carpeta.mkdirs();
        archivoPDF = new File(carpeta, "ReporteGenero.pdf");
    }
    ...
    public void crearTabla(String[] encabezado, ArrayList<ReporteLibrosxGenero> listaReporteLibrosxGenero){
        ...
        try{
            ...
            int total = 0;
            for(int indiceFila = 0; indiceFila < listaReporteLibrosxGenero.size(); indiceFila++){
                String autor = listaReporteLibrosxGenero.get(indiceFila).getGenero();
                String cantidad = listaReporteLibrosxGenero.get(indiceFila).getCantidad();
                ArrayList<String> listatitulos = listaReporteLibrosxGenero.get(indiceFila).getTitulos();
